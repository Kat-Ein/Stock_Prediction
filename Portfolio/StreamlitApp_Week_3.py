...
MODEL_INFO = {
    ...
    #increased features list
        "keys": ["PANW", "UBER", "DEXJPUS", "DEXUSUK", "SP500", "DJIA", "VIXCLS", "HL_Diff", "OC_Diff", "HC_Diff", "CL_Diff", "end_of_quarter"],
        "inputs": [{"name": k, "type": "number", "min": -1.0, "max": 1.0, "default": 0.0, "step": 0.01} for k in ["PANW", "UBER", "DEXJPUS", "DEXUSUK", "SP500", "DJIA", "VIXCLS", "HL_Diff", "OC_Diff", "HC_Diff", "CL_Diff", "end_of_quarter"]]
}
